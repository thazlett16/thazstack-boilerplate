...
export const datePickerVariants = tv({
  slots: {
    ...
    // Group: date input + trigger button row
    group: [
    ...
    // DateInput inside the group
    input: 'flex-1 h-full px-3 text-sm outline-none',
    ...
    // Popover panel
    popover: [
      'overflow-auto rounded-xl border border-foreground/15 bg-surface-default shadow-lg outline-none p-3',

...
import type { PopoverProps } from '#src/components/ui/popover';

import { dropdownItemStyles } from '#src/components/ui/list-box';
...
export function MenuTrigger(props: MenuTriggerProps) {
  let [trigger, menu] = Children.toArray(props.children) as [ReactElement, ReactElement];
  return (

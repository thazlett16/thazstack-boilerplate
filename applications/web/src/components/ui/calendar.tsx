...
import { composeTailwindRenderProps, focusRing } from '#src/lib/react-aria-utils';
...
export function CalendarGridHeader() {
  return (
    <AriaCalendarGridHeader>
      {(day) => <CalendarHeaderCell className="text-xs text-neutral-500 font-semibold">{day}</CalendarHeaderCell>}
    </AriaCalendarGridHeader>
  );
}
